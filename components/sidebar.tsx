...
export function Sidebar({
  ...
  return (
    <aside
      className={`sticky top-0 flex h-screen shrink-0 flex-col border-r border-line bg-surface transition-all ${
    ...
    >
      ...
      <div className="border-t border-line px-3 py-4">
        {!collapsed && <p className="mb-2 px-2.5 text-xs text-ink/40">Konto</p>}
