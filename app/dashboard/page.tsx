...
export default async function DashboardPage() {
  ...
  const cards = [
    ...
    { href: "/vedligeholdelse", label: "MRR", value: `${mrr.toLocaleString("da-DK")} kr.` },
    { href: "/support", label: "Åbne supportsager", value: openSupportRes.count ?? 0 },
  ];
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-8 card p-5">
          <h2 className="text-sm font-semibold text-ink/75">Fornyelser inden for 60 dage</h2>
