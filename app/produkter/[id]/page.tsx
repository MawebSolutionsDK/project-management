        ...
        <div className="mx-auto max-w-2xl">
          ...
          <form action={updateWithId} className="card space-y-4 p-6">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <Field label="Navn" name="name" defaultValue={product.name} required />
              <Field label="Kategori" name="category" defaultValue={product.category ?? ""} />
            </div>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <Field
              ...
              <div>
                ...
                <select name="pricing_type" defaultValue={product.pricing_type} className="input">
            ...
            <div>
              ...
              <textarea name="notes" rows={3} defaultValue={product.notes ?? ""} className="input" />
            </div>
