...
export default async function NytLeadPage({ searchParams }: { searchParams: { customer_id?: string } }) {
      ...
      <main className="mx-auto max-w-6xl px-6 py-10">
        ...
        <form action={createLead} className="card space-y-4 p-6">
          <div>
            ...
            <select name="customer_id" defaultValue={searchParams.customer_id ?? ""} className="input">
